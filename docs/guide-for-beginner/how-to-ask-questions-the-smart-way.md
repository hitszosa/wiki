...
> O4: 但你也许可以在我们的 QQ 群或者 Telegram 群获得"实际支持服务"
...
> O4: 本章内容完全由 Origami404 编写，与原文无关

本文是传世经典，你会在许多技术论坛的置顶里看到指向这篇文章的链接。

然而，任何观点都有其时代性与文化性。你并不一定需要全盘接受作者的观点。下面是我本人对于这篇文章的一些意见，仅供参考。

就像你看到的那样，这篇文章的语气有点冲，你大概可以想到作者在面对所谓 "loser 的提问" 时的愤怒 :(. 事实上，大部分大佬在平时都是比较友善的 (只要你不是真的拿蠢到爆的问题去问 ta 或者是尝试直接让 ta 帮你写作业), 就算你的问题笨一点，其实也没多大关系。再者，我们并不是网络上的陌生人 ---- 我们都是哈工大的学子。所以，如果你有问题的话，不用太担心自己的问题蠢不蠢，只要你为解决问题付出了努力，就大胆地提出来吧。

下面是一些提炼过的重点。虽然我们强烈推荐你读完这篇文章，但如果你正在赶着 114514 个 DDL 并且还有一大堆活动要搞的话，你也许可以只读本章下面的内容：

### 学会提问

在问问题前，最好先判断一下你的问题里是否至少包含了一下信息：
...
> 好：我想修改 CodeBlock 的字体，我直接在菜单里改成了 Consolas，但是 CodeBlocks 的字体没有变化。我重启 CodeBlocks 之后它报错了，怎么办？(附上报错截图)
>
> 坏：CodeBlocks 启动不了怎么办？
...
我们非常清楚，有时候几句话的工夫有可能让一个新手折腾好几个小时。所以如果你在努力过后发现自己还是一头雾水，直接问吧。但是，于情于理，你都不应该问题都不过脑子就来问 ---- 至少自己试着先解决一下。

### 学会回答

#### 保持耐心

人都教不会，怎么教电脑？每个人都曾经是初学者，但不同的人在初学时的状态千差万别，就算你觉得这个问题你初学的时候就会了，也请保持耐心

#### 帮助他们把问题捋清楚

不懂概念的人几乎不可能一下切入重点，有时候帮助别人优化问题就是在解决问题

#### 对“RTFM/STFW/翻记录”保持平和

因为关注不到重点，很可能搜不到/搜到了也不知道。这种情况下你大可以给出关键词/答案链接/搜索截图。

如果你知道之前在群里聊过这个话题，你可以搜聊天记录给他。你总比提问者更熟悉你讲过的话，并且提问者不一定有那段时间的 QQ 记录。如果你懒，那至少给出搜对话的关键词。

### 学会搜索

#### 在哪搜？

**Google** > Bing >> Baidu >> 杂牌搜索

搜狗搜索可以搜公众号文章 (貌似)

#### 搜什么？

**不要问搜索引擎问题**, 搜索引擎不是人，它只会按照关键词来给你文章，仅此而已。你需要且仅需要往搜索引擎中输入你问题中的关键字 (比如你的基本环境，你操作的对象，这个问题独特的信息).

> 例子：
>
> 好：CodeBlocks 字体 <报错信息>
>
> 坏：为什么 CodeBlocks 打开报错了 / CodeBlocks 打开报错怎么办

**不要塞进只有你有的独特的信息**, 比如编译报错中的变量名/函数名/行号。

#### 看什么？

搜到的结果，首先看网站 (SO/知乎/博客园/掘金/CSDN/个人博客), 那些域名很重复，摘要很重复的网站，一看就没啥好看的。

> 我们把这类网站叫 SEO 网站：它们只会往网站里赛一堆的关键词和广告，借助关键词提高自己在搜索中的排名，然后骗你点进去看广告

点进去之后先别人的环境 (他有什么，他的环境是不是跟我一样？), 然后看操作，(思考一下操作都在干什么？). 如果你之前自己做过一些努力，那么你还需要跟自己做过的比对。如果你懒得想，那么看看能不能撤销/恢复一些环境让自己的状态跟他一样。
...
> O4: 此处的 "黑客" 指 Hacker 的本意：对于计算机及计算机网络内部系统运作特别感兴趣并且有深入理解能力的一群人。
>
> 在中文圈里，黑客现在经常指 Cracker，即一个恶意（一般是非法地）试图破解某个程序、系统或网络，进而窃盗、毁损或使其瘫痪的人。
>
> 下面是[维基百科](https://zh.wikipedia.org/zh-cn/%E9%BB%91%E5%AE%A2)的定义：
>
> > 黑客与溃客
> >
...
> >
> > 这一群人试图破解某个程序、系统或网络，依目的大致可分为 3 个类型：白帽黑客（White Hat）、灰帽黑客（Grey Hat）、黑帽黑客（Black Hat），该名称取自美国电影西部片中，正派往往戴白帽，反派往往戴黑帽。白帽黑客以“改善”为目标，破解某个程序做出（往往是好的）修改，而增强（或改变）该程序之用途，或者透过入侵去提醒设备的系统管理者其安全漏洞，有时甚至主动予以修补，故又称“道德黑客”（Ethical Hacker）。灰帽黑客以“昭告”为目标，透过破解、入侵去炫耀自己拥有高超的技术，或者宣扬某种理念。黑帽黑客以“利欲”为目标，透过破解、入侵去获取不法利益，或者发泄负面情绪。其中，白帽黑客大多是电脑安全公司的雇员，抑或响应招测单位的悬赏，通常是在合法的情况下攻击某系统，而黑帽黑客同时也被称作“Cracker”（溃客）。
> >
> > “Cracker”（溃客）之相异其他黑客是在于：
> >
> >     一个恶意（一般是非法地）试图破解某个程序、系统或网络，进而窃盗、毁损或使其瘫痪的人。
> >     Cracker 没有道德标准，也没有“黑客精神”。
> >     Hacker 建设，而 Cracker 破坏。
> >
> > 但是这两个英文词常被翻译成同一个中文词，于香港（及澳门）依广东话被音译为“黑客”，于台湾被音译为“骇客”，而中国则是采用前者（但用普通话发音），故中文里的“黑客”经常指的是 Hacker 和 Cracker 中的任何一个。也就是说在误解下，“黑客”一词既指对编程语言有足够了解并喜欢编程的人，也有可能指恶意破坏者。然而在英文里，Hacker 和 Cracker 这两个词的意思是有所差异的。
> > 脚本小子
...
> O4: 新闻群组，你可以非常近似地将其看作早期的 BBS，这是一个比较古老的事物了
>
> 维基百科：
> > 新闻组（Newsgroup）是一个通常在 Usenet 中用于存储来自不同地区的用户所发表的信息的“仓库”。新闻组这个名字本身多少会产生一点歧义，因为它通常是一个讨论组。新闻组与万维网上的论坛在技术上完全不同，但功能上却是比较相似的。新闻组通常使用 NNTP 协议，使用特定的客户端来阅读和发送讨论的内容。
>
> 类比这里的要求，你提问之前可能需要先搜一下 QQ 聊天记录
...
> O4: Stack Overflow 在当下已经成为了 **最重要的且最广泛** 的编程相关问题的收集网站了，至少我每天都在用 :)
>
> 重要程度仅次于 Google
...
>
> 邮件列表：是一个跑在特定服务器上的邮箱，但是它会把收到的邮件转发到所有订阅了这个邮件列表的人
...
> O4: 现在很多开源项目都放在 Github 上并使用 Github issue 来管理问题，所以在现在你可以把这里的 "邮件列表" 等价替换为 issue
...
> O4: 偶尔，当有其他人问了别人问过我的问题时，我会直接转发聊天记录给他; 或者是，当我跟别人聊过一段比较广泛的技术方向之类的天的时候，我也有可能会保留聊天记录并转给可能感兴趣的其他人。
>
> 一般来讲我不会转发对方发出的消息，除非 ta 的消息包含了理解上下文必须的信息。
>
> 我相信其他人也许也会这样做，如果你出于一些原因不想泄漏这些对话，你必须 **提前** 跟对方要求，因为正常的人会期望他们能自由使用他们作出的回答。

### 使用清晰、正确、精准且合乎语法的语句

> O4: 对于数学类问题，这意味着你最好把公式写清楚了，并且使用通用的符号
>
> 对于电脑问题，这意味着你最好使用 **截图** 而不是拍屏幕，并且尽可能地调整图片方向至 **便于阅读** 的方向
>
> 你可以使用 QQ 截图，Win+Shift+S，或者 PriSc 按键
...
> O4: 这也意味这你最好不要使用不能在手机 QQ 上方便打开的格式来提问，因为大部分时候回答者都是在上课摸鱼的时候聊天，他们不一定有电脑
>
> 特别地，代码请优先提供 IDE 内的截图，然后是纯文本文件，如果回答者要求的话。最好不要在群聊里直接粘贴大段代码，这有刷屏的嫌疑。
>
> 如果代码有报错/警告的话，切记包含其于截图中，并且给出报错/警告行号附近的代码。
...
> O4: 也就是说，你要尝试给出 **最小复现代码**, 即最少的但是可以反映出你的问题的可以编译运行的完整代码片段，而不是一股脑地把乱七八糟的代码往上扔，同时还因为担心被抄而不放全部代码。
>
> 最小复现代码 >> 全部代码 > 不知所谓的代码片段
...
> O4: 也就是说，一般来讲，你代码的错误并不在你认为出错的地方出错，所以如果你对这个错误莫名其妙，请尝试给出最小复现代码或者全部代码，而不是你认为出错的那一段代码
...
> O4: 如果你从答案中获得新的感悟，发出来。有可能回答者也没想到那一方面。
...
> O4: 比如你如果在安装 CodeBlocks 的时候遇到问题请直接联系我 (维护 CodeBlocks 安装指南的人)
>
> 在回答者有需要的情况下，你最好配合一下他找到出错的原因而不是自己好了就行，因为这有可能节省更多的人更多的时间

如果你在研究一番后才作出了回答， **展现你的技巧而不是直接端出结果** 。毕竟`授人以鱼不如授人以渔`。

> O4: 对于回答者，如果你在研究过程中或者是你本身就知道一些扩展性的知识/其他解决方法，最好一并提出来，哪怕只是给个名字
