...
就像你看到的那样, 这篇文章的语气有点冲, 你大概可以想到作者在面对所谓 "loser 的提问" 时的愤怒 :(. 事实上, 大部分大佬在平时都是比较友善的(只要你不是真的拿蠢到爆的问题去问ta或者是尝试直接让ta帮你写作业), 就算你的问题笨一点, 其实也没多大关系. 再者, 我们并不是网络上的陌生人 ---- 我们都是哈工大的学子. 所以, 如果你有问题的话, 不用太担心自己的问题蠢不蠢, 只要你为解决问题付出了努力, 就大胆地提出来吧. 
...
> 好: 我想修改 CodeBlock 的字体, 我直接在菜单里改成了 Consolas, 但是CodeBlocks 的字体没有变化. 我重启 CodeBlocks 之后它报错了, 怎么办?(附上报错截图)
> 
...
如果你知道之前在群里聊过这个话题, 你可以搜聊天记录给他. 你总比提问者更熟悉你讲过的话, 并且提问者不一定有那段时间的QQ记录. 如果你懒, 那至少给出搜对话的关键词.
